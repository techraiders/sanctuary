...
(function(f) {
  ...
  function takeLast(n) {
    return function(xs) {
      return n < 0 || n > xs.length ? Nothing
  ...
  def ('match')
      ({})
      ([$.NonGlobalRegExp, $.String, $Maybe (Match)])
      (curry2 (match));
  ...
  def ('matchAll')
      ({})
      ([$.GlobalRegExp, $.String, $.Array (Match)])
      (matchAll);
